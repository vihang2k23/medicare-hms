                  ...
                  slots.map((s) => {
                    ...
                    return (
                      <button
                        ...
                        className="rounded-lg px-2 py-2 text-xs font-mono tabular-nums text-slate-600 dark:text-white bg-emerald-500/10 hover:bg-emerald-500/20 dark:hover:bg-emerald-500/15 ring-1 ring-emerald-500/20 transition-colors text-center"
                      >
                        {s.startStr} – {s.endStr}
                        <span className="block text-[10px] font-sans font-normal text-emerald-800/80 dark:text-white mt-0.5">
                          Book
                        </span>
                      </button>
                    )
