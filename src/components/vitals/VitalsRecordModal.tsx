  ...
  return (
    ...
    >
      <button
        ...
        onClick={handleClose}
      />
      <div className="relative w-full sm:max-w-xl max-h-[min(100dvh,44rem)] sm:max-h-[90vh] flex flex-col rounded-t-2xl sm:rounded-2xl border border-slate-200/90 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-2xl shadow-slate-900/25 dark:shadow-black/40 ring-1 ring-slate-200/60 dark:ring-slate-700/60 mt-auto sm:mt-0">
        ...
        <div className="overflow-y-auto overscroll-contain px-5 py-5 space-y-5 flex-1 min-h-0">
