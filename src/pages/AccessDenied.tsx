...
export default function AccessDenied() {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
      <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-red-50 dark:bg-red-950/40 text-red-600 dark:text-white mb-6 ring-1 ring-red-200/60 dark:ring-red-500/20 shadow-sm">
      ...
      <p className="text-slate-600 dark:text-white mb-8 max-w-sm text-sm leading-relaxed">
