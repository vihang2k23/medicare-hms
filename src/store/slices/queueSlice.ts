...
import { pickDoctorForDepartment } from '../../domains/queue/opdQueueDoctors'
import type { OpdQueueToken, OpdTokenStatus } from '../../domains/queue/opdQueueTypes'

export type { OpdQueueToken, OpdTokenStatus } from '../../domains/queue/opdQueueTypes'
